...
1. **Access the GitHub Repository**  
   - Assuming you have access to `https://github.com/anabottura/DE-workshop-10-Learner-AB`  
...
3. **Launch the Stack**  
   ...
   - On the **Parameters** page, fill in `ProjectName=ws10-orch`, `EnvironmentName=dev`, `EksVersion=1.32`.  
